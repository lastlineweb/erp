                              ...
                              <!-- /.btn-group -->
											...
											@foreach( $units as $key => $unit)
												<tr >
													...
													<span> <a  class="btn btn-suucess btn-sm" href="{{route('unit.delete' ,$unit->id)}}"><i class="fa fa-trash"></i></a></span>
                              ...
                              <!-- /.btn-group -->
											...
											@foreach( $productcategories as $key => $category)
												<tr >
													...
													<span> <a  class="btn btn-suucess btn-sm" href="{{route('unit.delete' ,$category->id)}}"><i class="fa fa-trash"></i></a></span>
